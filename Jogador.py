...
class Jogador:
    ...
    def __eq__(self,other):
        return self.nome==other.nome and self.qtdMoedas==other.qtdMoedas and self.valor_aposta==other.valor_aposta
    ...
    def alterar_aposta(self,valor,maior_aposta):
        ...
        if self.valor_aposta>maior_aposta:
            maior_aposta = self.valor_aposta
